...
const AddBlogs = () => {
  ...
  const addBlogHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await api.post('/api/blogs/add', {
        ...
        <div className="card-body position-relative">
          <div className="row">
            <div className="col-lg-8">
              ...
              <p className="mt-2">
                <NavLink className="btn btn-link ps-0 btn-sm" to="/posts" rel="noopener noreferrer">
                  <code className='badge rounded-pill badge-soft-dark' style={{ fontSize: "20px" }}>
                    <i className="fa-solid fa-eye"></i> Volver Ver Blogs. <span className="fas fa-chevron-right ms-1 fs--2" style={{ fontSize: "20px" }} />
                  </code>
                </NavLink>
              </p>
            </div>
