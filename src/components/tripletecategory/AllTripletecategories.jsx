        ...
        <div className="card-header">
          <div className="row flex-between-center">
            <div className="col-6 col-sm-auto d-flex align-items-center pe-0">
              <h5 className="fs-0 mb-0 text-nowrap py-2 py-xl-0"><i className="fa-solid fa-eye"></i> Mega-Desplegable Categor&#237;as Recientes. </h5>
            </div>
          </div>
        </div>
        <div className="card-body px-0 pt-0">
          {
            tripletecategory.length === 0 ? (
              <h3 className='no-data'>¡.Actualmente NO Hay Mega-Desplegable Categor&#237; as.!</h3>
            ) : (
              <>
                {
