              ...
              <div className="card-body position-relative">
                <div className="row">
                  <div className="col-lg-12">
                    <h3>
                      <code>
                        <FontAwesomeIcon icon="fa-solid fa-ruler" /> Listado De La Talla 📏.
                      </code>
                    </h3>
                    <a className="btn btn-link ps-0 btn-sm" href="/addsizes" rel="noopener noreferrer">
                    ...
                    <a className="btn btn-link ps-0 btn-sm" href="/sizes" rel="noopener noreferrer">
